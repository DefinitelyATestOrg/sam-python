...
from sam_python._exceptions import APITimeoutError, APIStatusError, APIResponseValidationError
...
from sam_python._models import FinalRequestOptions, BaseModel
from sam_python._types import NOT_GIVEN, Headers, NotGiven, Query, Body, Timeout, Omit
from sam_python._base_client import DEFAULT_TIMEOUT, HTTPX_DEFAULT_TIMEOUT, BaseClient, RequestOptions, make_request_options
from sam_python._streaming import Stream, AsyncStream
from sam_python._constants import RAW_RESPONSE_HEADER
from sam_python._response import APIResponse, AsyncAPIResponse
...
class TestSam:
    ...
    def test_copy_default_headers(self) -> None:
        client = Sam(base_url=base_url, _strict_response_validation=True, default_headers={
            "X-Foo": "bar"
        })
    ...
    def test_copy_default_query(self) -> None:
        client = Sam(base_url=base_url, _strict_response_validation=True, default_query={
            "foo": "bar"
        })
    ...
    def test_default_headers_option(self) -> None:
        ...
        client2 = Sam(base_url=base_url, _strict_response_validation=True, default_headers={
            "X-Foo": "stainless",
    ...
    @pytest.mark.parametrize("client", [Sam(base_url="http://localhost:5000/custom/path/", _strict_response_validation=True), Sam(base_url="http://localhost:5000/custom/path/", _strict_response_validation=True, http_client=httpx.Client())], ids = ["standard", "custom http client"])
    ...
    def test_retrying_timeout_errors_doesnt_leak(self, respx_mock: MockRouter) -> None:
        ...
        with pytest.raises(APITimeoutError):
            self.client.post("/store/order", body=cast(object, dict()), cast_to=httpx.Response, options={"headers": {RAW_RESPONSE_HEADER: "stream"}})
    ...
    def test_retries_taken(
        ...
        respx_mock.post("/store/order").mock(side_effect=retry_handler)
...
class TestAsyncSam:
    ...
    def test_copy_default_headers(self) -> None:
        client = AsyncSam(base_url=base_url, _strict_response_validation=True, default_headers={
            "X-Foo": "bar"
        })
        assert client.default_headers['X-Foo'] == 'bar'
    ...
    def test_copy_default_query(self) -> None:
        client = AsyncSam(base_url=base_url, _strict_response_validation=True, default_query={
            "foo": "bar"
        })
        assert _get_params(client)['foo'] == 'bar'
    ...
    def test_default_headers_option(self) -> None:
        ...
        client2 = AsyncSam(base_url=base_url, _strict_response_validation=True, default_headers={
            "X-Foo": "stainless",
            "X-Stainless-Lang": "my-overriding-header",
        })
        request = client2._build_request(FinalRequestOptions(method="get", url='/foo'))
    ...
    @pytest.mark.parametrize("client", [AsyncSam(base_url="http://localhost:5000/custom/path/", _strict_response_validation=True), AsyncSam(base_url="http://localhost:5000/custom/path/", _strict_response_validation=True, http_client=httpx.AsyncClient())], ids = ["standard", "custom http client"])
    ...
    async def test_retrying_timeout_errors_doesnt_leak(self, respx_mock: MockRouter) -> None:
        ...
        with pytest.raises(APITimeoutError):
            await self.client.post("/store/order", body=cast(object, dict()), cast_to=httpx.Response, options={"headers": {RAW_RESPONSE_HEADER: "stream"}})
