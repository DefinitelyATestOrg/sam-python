...
You can release to package managers by using [the `Publish PyPI` GitHub action](https://www.github.com/DefinitelyATestOrg/sam-python/actions/workflows/publish-pypi.yml). This will require a setup organization or repository secret to be set up.
